        ...
        <main>
            ...
            <form name="frmCalculo" action="" method="post">
                ...
                <div id="radios">
                    ...
                    <div>
                    <input type="radio" name="rdoResultado" value="Soma"<?= $operacao =="SOMA" ? 'checked': '' ?>><span>Somar </span>
                    </div>
                    <div>
                    <input type="radio" name="rdoResultado" value="Sub" <?= $operacao=='SUB' ?'checked' : ''?>><span>Subtrair</span>
                    </div>
                    <div>
                    <input type="radio" name="rdoResultado" value="Mult" <?= $operacao == 'MULT' ? 'checked' : '' ?>><span>Multiplicar</span>
                    </div>
                    <div>
                    <input type="radio" name="rdoResultado" value="Div" <?= $operacao == 'DIV' ?'checked' : "" ?>><span>Dividir</span>
                    </div>
                </div>
                <div id="resultado">
